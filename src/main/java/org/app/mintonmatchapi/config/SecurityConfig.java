...
import org.app.mintonmatchapi.auth.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/matches/*").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/matches/*/finish").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/matches/*/cancel").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/matches/*/cancel").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/matches/*/reviews").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/matches/*/penalties").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/matches/*/chat").authenticated()
